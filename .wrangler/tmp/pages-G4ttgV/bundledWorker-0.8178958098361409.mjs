...
var F = /* @__PURE__ */ __name((e, t, a) => (a = e != null ? ae(ie(e)) : {}, ce(t || !e || !e.__esModule ? U(a, "default", { value: e, enumerable: true }) : a, e)), "F");
var g;
var u = N(() => {
  g = { collectedLocales: [] };
});
...
var M = class {
  ...
  applyLocaleRedirects(t) {
    ...
    let { locale: { redirect: s, cookie: n } } = t, i = n && this.cookies[n], r = O(i ?? ""), o = O(this.reqCtx.request.headers.get("accept-language") ?? ""), h = [...r, ...o].map((y) => s[y]).filter(Boolean)[0];
    if (h) {
 ...
 * MIT Licensed
 */
//# sourceMappingURL=bundledWorker-0.8178958098361409.mjs.map
